...
public class ModelFairy extends ModelBiped {
  public ModelFairy() { this(0.0F); }

  public ModelFairy(final float f) { this(f, 0.0F); }
  ...
  public ModelFairy(final float f, final float f1) {
    ...
    strand3.setTextureOffset(13, 23).addBox(-3F, -1.5F, -1.5F, 3, 3, 3,
                                            f - 0.5F);
    strand3.setTextureOffset(13, 23).addBox(-5.25F, -1.5F, -1.5F, 3, 3, 3,
                                            f - 0.25F);
    ...
    strand4.mirror = true;
    strand4.setTextureOffset(13, 23).addBox(0F, -1.5F, -1.5F, 3, 3, 3,
                                            f - 0.5F);
    strand4.setTextureOffset(13, 23).addBox(2.25F, -1.5F, -1.5F, 3, 3, 3,
                                            f - 0.25F);
