...
public class ModelFairyProps2 extends ModelBiped {
  public ModelFairyProps2() { this(0.0F); }

  public ModelFairyProps2(final float f) { this(f, 0.0F); }

  public ModelFairyProps2(final float f, final float f1) {
    ...
    rogueHead.setTextureOffset(0, 0).addBox(-3F, -6.0F, -3F, 6, 6, 6,
                                            f + 0.125F);
    rogueHead.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
    rogueBody = new ModelRenderer(this);
    rogueBody.setTextureOffset(0, 19).addBox(-2F, 0.0F, -1F, 4, 6, 2,
                                             f + 0.375F);
    rogueBody.setTextureOffset(12, 19).addBox(-2F, 1.0F, -2F, 4, 2, 1,
                                              f + 0.375F);
  ...
  public void setRotationAngles(final float f, final float f1, final float f2,
    ...
    if (leftArmPose != ArmPose.EMPTY) {
      rogueLeftArm.rotateAngleX =
          rogueLeftArm.rotateAngleX * 0.5F - ((float)Math.PI / 10F);
    }

    if (rightArmPose != ArmPose.EMPTY) {
      rogueRightArm.rotateAngleX =
          rogueRightArm.rotateAngleX * 0.5F - ((float)Math.PI / 10F);
    }
    ...
    if (swingProgress > -9990F) {
      ...
      rogueBody.rotateAngleY =
          MathHelper.sin(MathHelper.sqrt(f6) * (float)Math.PI * 2.0F) *
          0.2F;
      wingLeft.rotateAngleY = wingRight.rotateAngleY =
          MathHelper.sin(MathHelper.sqrt(f6) * (float)Math.PI * 2.0F) *
          0.2F;
      rogueRightArm.rotationPointZ =
          MathHelper.sin(rogueBody.rotateAngleY) * 5F;
      rogueRightArm.rotationPointX =
          -MathHelper.cos(rogueBody.rotateAngleY) * 5F + 2.0F;
      rogueLeftArm.rotationPointZ =
          -MathHelper.sin(rogueBody.rotateAngleY) * 5F;
      rogueLeftArm.rotationPointX =
          MathHelper.cos(rogueBody.rotateAngleY) * 5F - 2.0F;
    ...
    rogueBlade1.rotateAngleX = rogueBlade2.rotateAngleX =
        rogueRightArm.rotateAngleX;
    rogueBlade1.rotateAngleY = rogueBlade2.rotateAngleY =
        rogueRightArm.rotateAngleY;
    rogueBlade1.rotateAngleZ = rogueBlade2.rotateAngleZ =
        rogueRightArm.rotateAngleZ;
    rogueBlade1.rotationPointX = rogueBlade2.rotationPointX =
        rogueRightArm.rotationPointX;
    rogueBlade1.rotationPointY = rogueBlade2.rotationPointY =
        rogueRightArm.rotationPointY;
    rogueBlade1.rotationPointZ = rogueBlade2.rotationPointZ =
        rogueRightArm.rotationPointZ;
  }
