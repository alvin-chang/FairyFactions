...
public class FairyModelRenderer extends ModelRenderer {
  public FairyModelRenderer(final ModelBase modelbase, final int i,
                            final int j) {
    super(modelbase, j, j);
    field_35971_a = 64F;
    field_35970_b = 32F;
  ...
  @Override
  public ModelRenderer addBox(final float offX, final float offY,
                              final float offZ, final int width,
  ...
  @Override
  public void addBox(final float offX, final float offY, final float offZ,
