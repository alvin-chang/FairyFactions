...
public class ModelFairyProps extends ModelBiped {
  public ModelFairyProps() { this(0.0F); }
  ...
  public ModelFairyProps(final float f, final float f1) {
    ...
    bipedBody.setTextureOffset(0, 16).addBox(-2F, 1.0F, -2F, 4, 2, 1,
                                             f + 0.25F);
    ...
    scoutBody.setTextureOffset(28, 7).addBox(-2F, 0.0F, -1F, 4, 6, 2,
                                             f + 0.125F);
    scoutBody.setTextureOffset(28, 15).addBox(-2F, 1.0F, -2F, 4, 2, 1,
                                              f + 0.125F);
    ...
    medicHead.setTextureOffset(0, 19).addBox(-3F, -5.5F, -3F, 6, 1, 6,
                                             f + 0.2F);
    medicHead.setTextureOffset(10, 15).addBox(-1.5F, -7.0F, -3.125F, 3, 3, 1,
                                              f + 0.2F);
    medicHead.setTextureOffset(24, 0).addBox(-3F, -3.5F, -3F, 6, 1, 6,
                                             f + 0.2F);
    medicHead.setTextureOffset(42, 3).addBox(-2.5F, -4F, -3.5F, 2, 2, 1,
                                             f + 0.2F);
    medicHead.setTextureOffset(42, 3).addBox(0.5F, -4F, -3.5F, 2, 2, 1,
                                             f + 0.2F);
    medicHead.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
    medicBody = new ModelRenderer(this);
    medicBody.setTextureOffset(28, 18).addBox(-2F, 0.0F, -1F, 4, 6, 2,
                                              f + 0.125F);
    medicBody.setTextureOffset(18, 18).addBox(-2F, 1.0F, -2F, 4, 2, 1,
                                              f + 0.125F);
    medicBody.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
  }

  @Override
  public void render(final Entity e, final float f, final float f1,
  ...
  public void setRotationAngles(final float f, final float f1, final float f2,
    ...
    if (!flymode) {
      bipedRightArm.rotateAngleX =
          MathHelper.cos(f * 0.6662F + (float)Math.PI) * 2.0F * f1 * 0.5F;
    ...
    if (leftArmPose != ArmPose.EMPTY) {
      bipedLeftArm.rotateAngleX =
          bipedLeftArm.rotateAngleX * 0.5F - ((float)Math.PI / 10F);
    }

    if (rightArmPose != ArmPose.EMPTY) {
      bipedRightArm.rotateAngleX =
          bipedRightArm.rotateAngleX * 0.5F - ((float)Math.PI / 10F);
    }
    ...
    if (swingProgress > -9990F) {
      ...
      bipedBody.rotateAngleY =
          MathHelper.sin(MathHelper.sqrt(f6) * (float)Math.PI * 2.0F) *
          0.2F;
      bipedRightArm.rotationPointZ =
          MathHelper.sin(bipedBody.rotateAngleY) * 5F;
      bipedRightArm.rotationPointX =
          -MathHelper.cos(bipedBody.rotateAngleY) * 5F + 2.0F;
      ...
      final float f9 = MathHelper.sin(swingProgress * (float)Math.PI) *
  ...
  public void setScoutRotationAngles(final float f, final float f1,
                                     final float f2, final float f3,
                                     final float f4, final float f5) {
    scoutHead.rotateAngleY = f3 / (180F / (float)Math.PI);
    scoutHead.rotateAngleX = f4 / (180F / (float)Math.PI);

    if (!flymode) {
      scoutRightArm.rotateAngleX =
          MathHelper.cos(f * 0.6662F + (float)Math.PI) * 2.0F * f1 * 0.5F;
      scoutLeftArm.rotateAngleX =
          MathHelper.cos(f * 0.6662F) * 2.0F * f1 * 0.5F;
      scoutRightLeg.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
      scoutLeftLeg.rotateAngleX =
          MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
    } else {
    ...
    if (leftArmPose != ArmPose.EMPTY) {
      scoutLeftArm.rotateAngleX =
          scoutLeftArm.rotateAngleX * 0.5F - ((float)Math.PI / 10F);
    }

    if (rightArmPose != ArmPose.EMPTY) {
      scoutRightArm.rotateAngleX =
          scoutRightArm.rotateAngleX * 0.5F - ((float)Math.PI / 10F);
    }
    ...
    if (swingProgress > -9990F) {
      float f6 = swingProgress;
      scoutBody.rotateAngleY =
          MathHelper.sin(MathHelper.sqrt(f6) * (float)Math.PI * 2.0F) *
          0.2F;
      wingLeft.rotateAngleY = wingRight.rotateAngleY =
          MathHelper.sin(MathHelper.sqrt(f6) * (float)Math.PI * 2.0F) *
          0.2F;
      scoutRightArm.rotationPointZ =
          MathHelper.sin(scoutBody.rotateAngleY) * 5F;
      scoutRightArm.rotationPointX =
          -MathHelper.cos(scoutBody.rotateAngleY) * 5F + 2.0F;
      scoutLeftArm.rotationPointZ =
          -MathHelper.sin(scoutBody.rotateAngleY) * 5F;
      scoutLeftArm.rotationPointX =
          MathHelper.cos(scoutBody.rotateAngleY) * 5F - 2.0F;
  ...
  public void setMedicRotationAngles(final float f, final float f1,
                                     final float f2, final float f3,
                                     final float f4, final float f5) {
