...
public class EntityAIFairyFollowOwner extends EntityAIBase {
	...
	public EntityAIFairyFollowOwner(EntityTameable tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
